  ...
  <div class="md:px-10 py-4">
    <div class="alert alert-info shadow-lg">
      <div>
        ...
        <span>Selamat Datang di Menu Yayasan.</span>
      </div>
    </div>
  </div>
  ...
  <div class="px-4 py-4">
    <div class="stats shadow stats-vertical md:stats-horizontal">
      <div class="stat">
        ...
        <div class="stat-value">{{ getIdentitas.jml_sekolah }} Sekolah</div>
      ...
      <div class="stat">
        ...
        <div class="stat-value">{{ getIdentitas.jml_kelas }} Kelas</div>
        <!-- <div class="stat-desc">Last Updated : 21 Juni 2022</div> -->
      </div>
      ...
      <div class="stat">
        ...
        <div class="stat-value">{{ getIdentitas.jml_siswa }} Siswa</div>
        <!-- <div class="stat-desc">Last Updated : 21 Juni 2022</div> -->
      </div>
    </div>
  </div>
